    ...
    <div className='bg-white w-full py-[10rem] px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
           {/* //cards */}
            ...
            <button className="text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto font-bold py-3 bg-black hover:bg-green-300 ">Get started</button>
            </div>

               {/* //cards */}
               <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-0 rounded-lg hover:scale-105 duration-300'>
